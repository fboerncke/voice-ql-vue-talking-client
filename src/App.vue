  ...
  <div id="app" class="flex flex-col w-screen h-screen bg-gray-300 dark:bg-gray-900">
    <div v-if="$client.speechRecognizer.isAvailable" class="flex flex-col flex-grow justify-center items-center">
      <div class="flex flex-col flex-grow justify-center items-center">
        <div class="px-8">
          <p class="text-lg text-center text-gray-800 dark:text-gray-400">{{ explanationText }}</p>
          <p class="text-lg text-center text-gray-800 dark:text-gray-400">&nbsp;</p>
          <p class="text-lg text-center text-gray-800 dark:text-gray-400 italic">
            &bdquo;{{ outputText }}&ldquo;
          </p>
        </div>
      </div>
...
export default class App extends Vue {
  inputText = '';
  explanationText = 'Voice-QL: Sprich im Browser mit Deiner Datenbank (Google Chrome only) ';
  outputText = 'Klicke unten auf den Knopf, um den Dialog zu beginnen.';
